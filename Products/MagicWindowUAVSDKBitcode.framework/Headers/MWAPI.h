...
+ (void)setCustomAction:(nonnull NSString *)action
             attributes:(nullable NSDictionary *)attributes __attribute__((deprecated("the method can't play")));;
...
+ (void)setCustomAction:(nonnull NSString *)action
             attributes:(nullable NSDictionary *)attributes
                success:(MWRealTimeSuccessBlock)successBlock
        failure:(MWRealTimeFailureBlock)failureBlock __attribute__((deprecated("the method can't play")));;
