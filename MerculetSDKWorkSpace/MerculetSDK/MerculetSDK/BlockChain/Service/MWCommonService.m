...
#define MW_CS_UPDATE_DEVICE                    @"mw_ud"
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        self.mwUrl = [MWURLService urlDomain];
    }
    return self;
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setBool:YES forKey:MW_CS_UPDATE_DEVICE];
    [userDefaults synchronize];
}
...
{
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    return [defaults boolForKey:MW_CS_UPDATE_DEVICE];
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults removeObjectForKey:MW_CS_UPDATE_DEVICE];
}
